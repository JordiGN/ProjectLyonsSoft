                    ...
                    <table class="table table-hover table-striped">
                         ...
                         <tbody>
                           ...
                           <tr>
                               ...
                               <td><a href="index.php/uploader/desactivaUmedida?id=<?php echo $rowUnimedidas['clave'];?>"></a><i class="fa fa-trash-o"></i></td>
                           </tr>
                           <?php } ?>
                         </tbody>
                    </table>
                  ...
                  <div class="col-lg-10 collapse navbar-collapse navbar-ex1-collapse" id="menuInferior">
                     <ul class="nav navbar-nav ">
                      ...
                      <ul class="nav navbar-nav navbar-right ">
                          <li id="lista3"><a href="index.php/welcome/matAltaUnidadesdeMedida">Add measurement unit<i class="fa fa-plus-square fa-lg"></i></a></li>
                      </ul>
                    </div>
                    <div class="col-lg-1"></div>
                  </div>
