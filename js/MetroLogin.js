...
var UserEnterMessage = "Por Favor, Ingresa tu Usuario.";
var RememberMeLabel  = "Recordar";
var LoadingMessage   = "Registrando.. Por Favor Espera."
var ErrorMessage     = "El Usuario o Contraseña no es Correcta.";
...
{
	$("#BackgroundUp").css("background-image","url(images/backgrounds/"+ URLimage +")");
...
content = '<div class="boxLoading"><img src="images/loading82.gif"><span>'+LoadingMessage+'</span></div>';
...
$("#BackgroundUp").css("background-image","url(images/backgrounds/"+ LockWallpaper +")");
...
{
	content += '<div class="boxBack"><img src="images/backgrounds/mini'+ Backgrounds[i] +'"/>'+ Backgrounds[i] +'</div>';
}
content += '</div>';
  	...
  	$("#frmLogin").submit(function()     //Name of the summited form.
        {
          ...
          $.ajax({
            ...
            url:      "index/loginCheck.php",         //URL is the page that use the summited information
...
$(".boxBack").click(function(){
	...
	$("#BackgroundUp").css("background-image","url(images/backgrounds/"+ BackImg +")");
